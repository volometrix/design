...
$.fn.showCode = function() {
  // $('body').append('<div class="page-menu btn-group" style="position:fixed;right:50%;margin-right:-25px;bottom:0;">'+
  //                   '<a href="#" class="btn btn-default" id="show-help-trigger">Help</a>'+
  //                   '<a href="#" class="" id="show-code-trigger">&lt;/&gt;</a></div>');
